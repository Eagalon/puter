...
* add alarms to meteringService if cost for service is unexpectedly 0 ([#1755](https://github.com/Eagalon/puter/issues/1755)) ([7e8842e](https://github.com/Eagalon/puter/commit/7e8842e35d73cea1afbda7127546b620fbb12feb))
* add missing Persian and Finnish translations ([#1614](https://github.com/Eagalon/puter/issues/1614)) ([b8263fd](https://github.com/Eagalon/puter/commit/b8263fd8e009f4d44ad41e788485f48ff81898e5))
* Add missing Portuguese translations ([#1615](https://github.com/Eagalon/puter/issues/1615)) ([1cff4fd](https://github.com/Eagalon/puter/commit/1cff4fd46a5489565f5dd7dffeb6f92a8f117989))
* Add missing Urdu translations ([#1618](https://github.com/Eagalon/puter/issues/1618)) ([72ee05f](https://github.com/Eagalon/puter/commit/72ee05fefbc3da7b3fd2a0e81f1b95d10f64abeb))
* Add missing Vietnamese translations ([#1641](https://github.com/Eagalon/puter/issues/1641)) ([a17ab22](https://github.com/Eagalon/puter/commit/a17ab22ab7758e8469f87afdcdf871b8f0b05fef))
* add OpenAI support to text-to-speech ([#1853](https://github.com/Eagalon/puter/issues/1853)) ([861aedd](https://github.com/Eagalon/puter/commit/861aeddf3ec1c90b6ba4fdef3df71ef8bf34507d))
* add openrouter metering ([#1724](https://github.com/Eagalon/puter/issues/1724)) ([248b199](https://github.com/Eagalon/puter/commit/248b199fa356653533a1adf092a194b90ad8c98a))
* add optional dotenv support ([15eb44d](https://github.com/Eagalon/puter/commit/15eb44d62df189afb20bd2bd6549f711cdfe69bf))
* add speech2text ([#1855](https://github.com/Eagalon/puter/issues/1855)) ([64f86da](https://github.com/Eagalon/puter/commit/64f86daddb8afb80980f35fc5f40a2974e1b7648))
* add tar and untar functionality for file management ([343f042](https://github.com/Eagalon/puter/commit/343f042f391b79877f8268176910475443906558))
* alert when going over usage limits significantly + egress metering ([#1782](https://github.com/Eagalon/puter/issues/1782)) ([27f2411](https://github.com/Eagalon/puter/commit/27f24118f34129e4083d4ba10b6d57fce4456593))
* allow for unlimitedAllowList + typedefs snuck in by accident ([#1813](https://github.com/Eagalon/puter/issues/1813)) ([219fd22](https://github.com/Eagalon/puter/commit/219fd2274cbf71aeeb3744810c3a26cbbc880b3f))
* allow setting puter origin via globalThis variables ([bf76a1e](https://github.com/Eagalon/puter/commit/bf76a1edea1a8b0fcd66181e52a454a7f6581889))
* Complete missing Ukrainian, Turkish and Thai translations ([#1616](https://github.com/Eagalon/puter/issues/1616)) ([733c7b6](https://github.com/Eagalon/puter/commit/733c7b638d0d9bfefbfdc72ed08eccfbd89fc81c))
* DAV Locks support + refactor of DAV method handler ([#1486](https://github.com/Eagalon/puter/issues/1486)) ([d70d412](https://github.com/Eagalon/puter/commit/d70d4121158547b3217664da498d2bcdae0a73c0))
* devCenter open ui message ([#1850](https://github.com/Eagalon/puter/issues/1850)) ([0bb1426](https://github.com/Eagalon/puter/commit/0bb14261c2e0c7cc69ea0a03b367fefa01334d7f))
* enforce new metering + get rid of old methods ([#1762](https://github.com/Eagalon/puter/issues/1762)) ([08e26af](https://github.com/Eagalon/puter/commit/08e26af85d5aa620a525fb9534766f04a1ae5e14))
* extract and centralize cost maps ([#1691](https://github.com/Eagalon/puter/issues/1691)) ([f06bec4](https://github.com/Eagalon/puter/commit/f06bec4cd482ae9e494704667d6ab036988411a4))
* immprove `UIPopover` and `UIWindow` behavior for sidepanel visibility ([#1711](https://github.com/Eagalon/puter/issues/1711)) ([64cfa81](https://github.com/Eagalon/puter/commit/64cfa8158d33018233aa06ff8ad3763ae443d6f3))
* initial metering service supporting monthly tracking of service consumption ([#1630](https://github.com/Eagalon/puter/issues/1630)) ([cc3b0db](https://github.com/Eagalon/puter/commit/cc3b0db6b1b0ca27a55b7f463674e0a3cc3377f3))
* introduce `PANEL_WIDTH` constant and refactor `UIWindow` for panel handling ([#1780](https://github.com/Eagalon/puter/issues/1780)) ([eb123d8](https://github.com/Eagalon/puter/commit/eb123d873f311374c4d5068ec898ad419a430496))
* limit alerting ([#1798](https://github.com/Eagalon/puter/issues/1798)) ([6bbd9bd](https://github.com/Eagalon/puter/commit/6bbd9bdc9f367ef260e8620673ebc7418f89bcd7))
* manage permission for user to user and dev to app file sharing ([#1567](https://github.com/Eagalon/puter/issues/1567)) ([d9c64a9](https://github.com/Eagalon/puter/commit/d9c64a93783dad59fb7a47a7be48f72ba4b4e272))
* meter claude ai ([#1716](https://github.com/Eagalon/puter/issues/1716)) ([73a24af](https://github.com/Eagalon/puter/commit/73a24af9516ddcca28efe1ccd09b638b7957730f))
* meter ll_read for the person reading ([#1854](https://github.com/Eagalon/puter/issues/1854)) ([62b6582](https://github.com/Eagalon/puter/commit/62b6582d854d48be8664edaf6a1868ed059562f4))
* meter open ai ([#1703](https://github.com/Eagalon/puter/issues/1703)) ([0acb884](https://github.com/Eagalon/puter/commit/0acb884ed0d5b63b009a8169121640cb6256425e))
* metering service allowence checks and subscription integration 🚀  ([#1749](https://github.com/Eagalon/puter/issues/1749)) ([e51d0c4](https://github.com/Eagalon/puter/commit/e51d0c460044bf3a390f2b2bd5a916b2c0ea8caf))
* purchase addons logic in metering ([#1765](https://github.com/Eagalon/puter/issues/1765)) ([b7cee87](https://github.com/Eagalon/puter/commit/b7cee8737073cdfef62df7ea13f16acfdec0e3b1))
* rawBody parser, user  metadata column + other misc fixes ([#1904](https://github.com/Eagalon/puter/issues/1904)) ([5ff8c7e](https://github.com/Eagalon/puter/commit/5ff8c7e0409f0427293c676213608309824af549))
* rename meteringAndBilling to metering ([#1800](https://github.com/Eagalon/puter/issues/1800)) ([16fd614](https://github.com/Eagalon/puter/commit/16fd614b8486737154d4cc3b12a40e55942f511d))
* route for global usage aggregate ([#1810](https://github.com/Eagalon/puter/issues/1810)) ([256189a](https://github.com/Eagalon/puter/commit/256189a7def735dcbd571eedd10e083bd67a7dc0))
* Settings and modal UI/UX improvements ([#1828](https://github.com/Eagalon/puter/issues/1828)) ([1919163](https://github.com/Eagalon/puter/commit/191916321be77502f77927a005edbb103f92a599))
* shard apps as well to avoid hot partitions ([#1799](https://github.com/Eagalon/puter/issues/1799)) ([435d266](https://github.com/Eagalon/puter/commit/435d26608a07265b0142110c226976bfa889589f))
* **Translation:** added support for Armenian and also added Bulgarian (Closes [#1523](https://github.com/Eagalon/puter/issues/1523)) ([#1676](https://github.com/Eagalon/puter/issues/1676)) ([3120d6a](https://github.com/Eagalon/puter/commit/3120d6a057705b761878bd64c94257867a001372))
* ui for dev account + util decorators for controllers in extension ([#1864](https://github.com/Eagalon/puter/issues/1864)) ([6037469](https://github.com/Eagalon/puter/commit/603746951b8da41ccce9a5b9301e5dcc1e8b1508))


### Bug Fixes

* access internal ID without assuming fetch ([a44e1fc](https://github.com/Eagalon/puter/commit/a44e1fc0743948203139781e1968c77012c34914))
* according to jquery spec, this is more robust ([52d4ca6](https://github.com/Eagalon/puter/commit/52d4ca6caf709955444065aadeeb02bacc00006c))
* add back non-functional changes ([#1888](https://github.com/Eagalon/puter/issues/1888)) ([93aaeef](https://github.com/Eagalon/puter/commit/93aaeef9e0b206289749e44c3a6cc1e83616890d))
* Add debounce to toolbar reveal when dragging windows to prevent accidental activation ([#1989](https://github.com/Eagalon/puter/issues/1989)) ([f6139bc](https://github.com/Eagalon/puter/commit/f6139bc79aa4dd1c08ad0659b540c7f22136bb37))
* add missing await in kv example extension ([9b34e67](https://github.com/Eagalon/puter/commit/9b34e67d0da3162ad1ff03a90220e9f69659a922))
* add missing Context import to IconResult ([71a2615](https://github.com/Eagalon/puter/commit/71a26156bd6dc9075b4b24fb24d41cf9b7170a48))
* add missing dep to whoami extension ([dabf8ca](https://github.com/Eagalon/puter/commit/dabf8cac56004863c68dc95420854b7341719aae))
* add missing ref to `next()` ([5062e3c](https://github.com/Eagalon/puter/commit/5062e3c5ed6e33f80b9086473f1eb2d7e859cf9a))
* add missing utilities.js ([39fdcec](https://github.com/Eagalon/puter/commit/39fdcec9bf05858824f39978f18672d8e2662db1))
* adding more benign changes ([#1891](https://github.com/Eagalon/puter/issues/1891)) ([85432c8](https://github.com/Eagalon/puter/commit/85432c886e838b9e2012dc08440e4b81b5d0a428))
* adjust toolbar positioning for sidepanel based on taskbar location ([#1731](https://github.com/Eagalon/puter/issues/1731)) ([9607706](https://github.com/Eagalon/puter/commit/9607706d11590c05f1f2393eaefc91487d53f0d6))
* **ai:** try overriding timeout to disable error ([1c64cb2](https://github.com/Eagalon/puter/commit/1c64cb274b4ae556d6fe0201fbd85dc8a921b2ac))
* allow mysql json object response ([#1918](https://github.com/Eagalon/puter/issues/1918)) ([0fd7100](https://github.com/Eagalon/puter/commit/0fd7100795619a667c2351cf559a0d4e208a9e4f))
* allow stripe header and commit db migration ([#1877](https://github.com/Eagalon/puter/issues/1877)) ([71fb04c](https://github.com/Eagalon/puter/commit/71fb04cd55130eae840ccfe8b2b3728f8b523037))
* alowance typo ([#1756](https://github.com/Eagalon/puter/issues/1756)) ([b4cafaa](https://github.com/Eagalon/puter/commit/b4cafaa5bb4c479edc02bf31fa9cdf23cfd4720f))
* also check this.entry.id when checking mysql_id ([cc7369d](https://github.com/Eagalon/puter/commit/cc7369d9d71b72b97929a2f1387c4f006bab5832))
* app monthly usage details error ([#1761](https://github.com/Eagalon/puter/issues/1761)) ([15b65da](https://github.com/Eagalon/puter/commit/15b65dab7d75fe42151eb650bf598512a39acb4d))
* apparently setters shadow getting ([b328355](https://github.com/Eagalon/puter/commit/b328355a907a045d7f4c13aa1636dbcbeea43178))
* backward compatibility for puter kv incr/decr ([#1697](https://github.com/Eagalon/puter/issues/1697)) ([2a2a1f6](https://github.com/Eagalon/puter/commit/2a2a1f6a99b6305f44d81b29aa81aafa7ed49aab))
* bad acl check returning early ([#1789](https://github.com/Eagalon/puter/issues/1789)) ([760bc22](https://github.com/Eagalon/puter/commit/760bc227430c3a7fe91054345cfbbc3ea2b6c199))
* bad amount of sql params ([#1879](https://github.com/Eagalon/puter/issues/1879)) ([98cf4bb](https://github.com/Eagalon/puter/commit/98cf4bbb081249cfa1d950e715853ded8f7f722c))
* bad amount of sql params ([#1880](https://github.com/Eagalon/puter/issues/1880)) ([89a3a32](https://github.com/Eagalon/puter/commit/89a3a3228f5bd1fe629bd98cf7464801261fef64))
* bad boolean check ([#1721](https://github.com/Eagalon/puter/issues/1721)) ([5450c85](https://github.com/Eagalon/puter/commit/5450c85b3a35840a0c3c73a1aa7fa1bd0b442284))
* bad math check for max consumed credits ([#1769](https://github.com/Eagalon/puter/issues/1769)) ([c38da86](https://github.com/Eagalon/puter/commit/c38da86293250d850c66693693849b759010eab7))
* bad naming ([#1878](https://github.com/Eagalon/puter/issues/1878)) ([7085bcb](https://github.com/Eagalon/puter/commit/7085bcbb93171eeaf8fc21ed969da1f5536e5547))
* bad null check ([#1770](https://github.com/Eagalon/puter/issues/1770)) ([9bdb139](https://github.com/Eagalon/puter/commit/9bdb139f7a82ef610e6beb76b91014ac530828a4))
* bad wrapper wrap ([#1908](https://github.com/Eagalon/puter/issues/1908)) ([490cd45](https://github.com/Eagalon/puter/commit/490cd4533646c64058645ca8ca861d43a49914d5))
* broken open ai moderation ([#1714](https://github.com/Eagalon/puter/issues/1714)) ([3df1d31](https://github.com/Eagalon/puter/commit/3df1d31a37b62ee0c7c245ef7ded482f8acae968))
* check if shraed files exist in ll_readshares ([baf261c](https://github.com/Eagalon/puter/commit/baf261c0c4677cd2e69925467e68bee946e9c264))
* check if system_prompts is an empty array ([d7ea676](https://github.com/Eagalon/puter/commit/d7ea6769cb47a97ccf4b743e343ea42712eab0cd))
* cleanup EngPortalService commands ([887536b](https://github.com/Eagalon/puter/commit/887536b811920733f903966e969aa7057d64ac01)), closes [#1624](https://github.com/Eagalon/puter/issues/1624)
* dbkv raw import ([#1848](https://github.com/Eagalon/puter/issues/1848)) ([ff9932b](https://github.com/Eagalon/puter/commit/ff9932b2f38d4e64de15937bcc410bc664d945f3))
* desktop_items in whoami ([7b38131](https://github.com/Eagalon/puter/commit/7b38131b65ddd415a15f68918482aa339a2926ea))
* do not animate non-existing captcha modal ([ec50536](https://github.com/Eagalon/puter/commit/ec505366e6e9bb46ca9279c91566557f51382ba4))
* don't set metadata until migration ([#1886](https://github.com/Eagalon/puter/issues/1886)) ([823c06c](https://github.com/Eagalon/puter/commit/823c06c371e0535405333be8b8b3f0ebb0e2d290))
* error calling .startsWith on null mime_type ([656a01f](https://github.com/Eagalon/puter/commit/656a01f2fab7fc04851bcbca534cbbe882b707cd))
* error logs are too verbose ([dc6a931](https://github.com/Eagalon/puter/commit/dc6a931a237463c7cb6b1c8d1798f4a77d610a84))
* eslint autofixable errors ([#2002](https://github.com/Eagalon/puter/issues/2002)) ([11e0575](https://github.com/Eagalon/puter/commit/11e057557dc593f3ca6a18c363b0880acb60b255))
* explicit actor not passed to fs provider ([3aadaf8](https://github.com/Eagalon/puter/commit/3aadaf84203f3a042ba67d2b66ffee1a631bdf22))
* fallback models ([#2005](https://github.com/Eagalon/puter/issues/2005)) ([262b359](https://github.com/Eagalon/puter/commit/262b3596331ed98371bf68d0b0b94e281d8d4284))
* **fs:** better errors for unresolved selectors ([7cc7907](https://github.com/Eagalon/puter/commit/7cc79077d1833969b3460d2f881b212682e9a6db))
* get rid of a console log ([b1facfb](https://github.com/Eagalon/puter/commit/b1facfbabd09c30b6516f68d61e4c52cc89408de))
* get rid of preflight for non-apifs readdir/stat ([8884c7f](https://github.com/Eagalon/puter/commit/8884c7f472f936e18b213b98b4fb514e534c4a2e))
* **i18n:** complete and clean up German translation ([#1893](https://github.com/Eagalon/puter/issues/1893)) ([4e91774](https://github.com/Eagalon/puter/commit/4e91774b9597e75196792c5ce90992b61d4826c1))
* id2path import ([fb41eaa](https://github.com/Eagalon/puter/commit/fb41eaae23cdd7bf6af5a14284b0f497099e0ff8))
* incorrect implementation of ll_mkdir ([6a2cac5](https://github.com/Eagalon/puter/commit/6a2cac5d573138779aeedea3f4e43882c9640ed9))
* incorrect variable ref in hl_move for shared ([d429d2f](https://github.com/Eagalon/puter/commit/d429d2f5bc355a75ab070e141c2d743b563a7383))
* increment for non-existent keys ([#1649](https://github.com/Eagalon/puter/issues/1649)) ([4a1aee0](https://github.com/Eagalon/puter/commit/4a1aee0713cd0cc749e09502e4cf67998f7c6a54))
* lessen alert triggering for metering ([#1837](https://github.com/Eagalon/puter/issues/1837)) ([fd8a88b](https://github.com/Eagalon/puter/commit/fd8a88b8f4bb784ff4f45ed38f0ce093418e95c6))
* metering service global write and open ai default model ([#1717](https://github.com/Eagalon/puter/issues/1717)) ([eea27be](https://github.com/Eagalon/puter/commit/eea27be8eb7874b26a471a8e8672efe9e9bb62ff))
* metering typos ([#1754](https://github.com/Eagalon/puter/issues/1754)) ([24a51c5](https://github.com/Eagalon/puter/commit/24a51c59aeffc388aaf30497d720ef6bc227a059))
* missing await in extension loader ([db5aef5](https://github.com/Eagalon/puter/commit/db5aef51b042ce850af893418283959500c7b6e6))
* missing check for dev console service ([b6e1276](https://github.com/Eagalon/puter/commit/b6e12762ce39e9387b9315f19a36a7b17ec1d70e))
* missing published/attached website icon for folder on different views ([#1764](https://github.com/Eagalon/puter/issues/1764)) ([#1945](https://github.com/Eagalon/puter/issues/1945)) ([2b8081d](https://github.com/Eagalon/puter/commit/2b8081d10087a5b668f315f1db3b56e8bfdb7175))
* move dependency in LocalDiskStorageController ([bb90595](https://github.com/Eagalon/puter/commit/bb90595431c67d7a686b5a0d76ace0efbbf9a69e))
* NaN value for consumedPurchaseCredits accounting ([#1767](https://github.com/Eagalon/puter/issues/1767)) ([fc7a51b](https://github.com/Eagalon/puter/commit/fc7a51bd2f700ed2ca5e1cdf06d58c4bdcbc181f))
* only fallback to models that are immediately the same ([#2001](https://github.com/Eagalon/puter/issues/2001)) ([f177397](https://github.com/Eagalon/puter/commit/f1773974c068155002c7b7aefc69c0f652210f9c))
* open router cache token metering ([#1988](https://github.com/Eagalon/puter/issues/1988)) ([02d95db](https://github.com/Eagalon/puter/commit/02d95db7edfbc6ff84ca8eaa8fae506a801fb8df))
* openai configuration regression ([16e7fe9](https://github.com/Eagalon/puter/commit/16e7fe985145a72469849b6da9221adf86e3d9b6))
* openrouter missing usage ([#2008](https://github.com/Eagalon/puter/issues/2008)) ([85d13a9](https://github.com/Eagalon/puter/commit/85d13a9d4b7ed7578494a3f84b11ff3f78173b7b))
* openrouter usage calculator ([#1725](https://github.com/Eagalon/puter/issues/1725)) ([c0d96c7](https://github.com/Eagalon/puter/commit/c0d96c7e97bab4d194f20743259bbc0dd8921532))
* options.no_options_auth should be optional chained ([44fcb58](https://github.com/Eagalon/puter/commit/44fcb5800b3fed7fce0c1fd4ce67d6415114e58f))
* package name ([9d5a09f](https://github.com/Eagalon/puter/commit/9d5a09f0bc7c4aa2499a900035941ec67dea4b5e))
* PayloadTooLargeError for JSON + base64 images ([b9f42f6](https://github.com/Eagalon/puter/commit/b9f42f6daa723ee830de1531e8c52e17be3c9837))
* permission batch get ([#1637](https://github.com/Eagalon/puter/issues/1637)) ([5b3bc9d](https://github.com/Eagalon/puter/commit/5b3bc9ddf4b425cd660ede7938c611532423e036))
* permission writeback to flat kv perissions ([#1774](https://github.com/Eagalon/puter/issues/1774)) ([686c2bc](https://github.com/Eagalon/puter/commit/686c2bc966f799cd290fbb59089dfa244dac0c19))
* possible undefined when handling stuck stream ([813ea63](https://github.com/Eagalon/puter/commit/813ea63d21b345a78ac8046384293833ec3bf7a4))
* preflight issue with protected endpoints ([a5fa16b](https://github.com/Eagalon/puter/commit/a5fa16b7bb322d22274eda2a87da7b196775fa53))
* prevent unnecessary updates on socket events ([ef74a1a](https://github.com/Eagalon/puter/commit/ef74a1a660dddc88a6db0a2b1a24cc99e381e9bb))
* quick fix for config context issue ([0c06040](https://github.com/Eagalon/puter/commit/0c06040e6cdbb1844f5522d8224a4a8b74d56bd8))
* references to `global_config` in puterfs ([705901f](https://github.com/Eagalon/puter/commit/705901fd2b8ffce2d5de49f139ead52863e7250e))
* remove unused AWS SDK v2 import ([4d8692f](https://github.com/Eagalon/puter/commit/4d8692fd310b8ca2b374643b26499d52cbf7da9d))
* remove verbose parameters log ([44522f0](https://github.com/Eagalon/puter/commit/44522f0a2259efcc53f7a90ee07c7c261f459610))
* rm another ref to storage, rm dupe meter ([db8f45f](https://github.com/Eagalon/puter/commit/db8f45f3867462ffd9932b85334679489250f18a))
* simplify export import typedef ([#1818](https://github.com/Eagalon/puter/issues/1818)) ([3fb3cf0](https://github.com/Eagalon/puter/commit/3fb3cf0e60a40e486a320935628b24dca288ff4e))
* size_measure_stream in streamutils ([92d03e5](https://github.com/Eagalon/puter/commit/92d03e55014a6c5bc5d9c492783f6b0455cfa3d7))
* support async iterator for AI chat streaming mode in types ([1affbb4](https://github.com/Eagalon/puter/commit/1affbb4cc860eeed2702380c2538a8fcb06cb893))
* Switch to new OpenAI Moderation model ([#1826](https://github.com/Eagalon/puter/issues/1826)) ([20601ce](https://github.com/Eagalon/puter/commit/20601ce5e4b953a5787e83677919425a519714b1))
* system actor for extension lifecycle events ([9ff59d9](https://github.com/Eagalon/puter/commit/9ff59d92902bc54aef1c0f8359a79b5c6a123599))
* throw error not lorem when moderation fails ([5b16774](https://github.com/Eagalon/puter/commit/5b16774a9a8007fcdcf8978a3302e5951883ad52))
* ts issue when building for deploy ([#1890](https://github.com/Eagalon/puter/issues/1890)) ([11d2515](https://github.com/Eagalon/puter/commit/11d2515cb283bba0cf9d12610170d9b751d28f20))
* typedefs ([44284eb](https://github.com/Eagalon/puter/commit/44284eb7881085cb3132d347b912f8102adb33de))
* undefined alias array ([#1709](https://github.com/Eagalon/puter/issues/1709)) ([248b38e](https://github.com/Eagalon/puter/commit/248b38e732264b40b9d5c3e62770b753d1a3a5cb))
* undefined svc_fs ([e735705](https://github.com/Eagalon/puter/commit/e7357054b085e62998f6bede0a054efce4161e85))
* update path when renaming during save_account ([088ff4d](https://github.com/Eagalon/puter/commit/088ff4d69657060e3cecc93f431fd1816d320138))
* usage limited issue whens treaming ([#1806](https://github.com/Eagalon/puter/issues/1806)) ([c9ab01c](https://github.com/Eagalon/puter/commit/c9ab01cf1ef42c43f8e3ed156be8f16e4a5ff5e8))
* use dynamic import for dotenv ([f729eaa](https://github.com/Eagalon/puter/commit/f729eaa31fe10e6b772c82ec5611002baead1994))
* x86 not booting locally ([#1959](https://github.com/Eagalon/puter/issues/1959)) ([849beec](https://github.com/Eagalon/puter/commit/849beecd4fea614334cfa1004e4b5f6a0dfb2cf1))


### Performance Improvements

* move user-user perm checks to flat kv entries ([#1562](https://github.com/Eagalon/puter/issues/1562)) ([9c47a7f](https://github.com/Eagalon/puter/commit/9c47a7f8caaa20521404285758bd6ecf06317e8e))


### Reverts

* commits for user metadata changes ([#1887](https://github.com/Eagalon/puter/issues/1887)) ([758bef0](https://github.com/Eagalon/puter/commit/758bef0582f3f674541f39591d0bce0ed3d2855b))
* eslint config rules ([#1625](https://github.com/Eagalon/puter/issues/1625)) ([3fc1832](https://github.com/Eagalon/puter/commit/3fc183297fb3740883ad8a20da73b055be3a17f7))
* fs metering ([#1790](https://github.com/Eagalon/puter/issues/1790)) ([4b14ef8](https://github.com/Eagalon/puter/commit/4b14ef863c436eaedcdbf14c2cf98a47ce573157))
* revert devex changes  ([#1728](https://github.com/Eagalon/puter/issues/1728)) ([fc725d0](https://github.com/Eagalon/puter/commit/fc725d0130b1ddfd888d1feceab3f718b297b729))
